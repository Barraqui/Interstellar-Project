...
<html lang="en">
    ...
    <body>
        ...
        <main>
            ...
            <div id="trailer">
                <div>
                    <iframe width="1280" height="536" src="https://www.youtube.com/embed/mbbPSq63yuM" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                </div>
                <div id="sinopse">
                    <h1>Sinopse</h1>
                    <p class="descricao">
